...
<div class="card">
  ...
  <p>AI 大模型聚合桌面客户端<br>一键访问 200+ 模型，写作/聊天/编程/绘图全能</p>
  ...
  <div style="margin-top:24px;padding-top:20px;border-top:1px solid rgba(255,255,255,.05);font-size:12px;color:#6b5b95">
    ...
    print("\n=== Creating download.html ===")
    
    # Use stdin to write the file via SSH
    ...
    print("download.html created!" if exit_status == 0 else "Failed")
    
    sftp.close()
    
    # Verify
    stdin, stdout, stderr = ssh.exec_command("ls -lah /home/admin/nexus-studio/download/index.html")
